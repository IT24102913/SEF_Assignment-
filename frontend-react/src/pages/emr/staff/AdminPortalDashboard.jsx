...
import { ShieldAlert, Users, FileText, Microscope, Pill, Trash2 } from 'lucide-react';
      ...
      {activeTab === 'consultations' && (
        <div style={{ backgroundColor: '#ffffff', border: '1px solid #cbd5e1', borderRadius: '16px', padding: '24px' }}>
          ...
          {consultations.length > 0 ? (
            ...
            <div style={{ textAlign: 'center', padding: '36px', color: '#94a3b8', fontSize: '0.92rem' }}>
              No consultation notes recorded in database yet.
            </div>
          )}
        </div>
      )}
      ...
      {activeTab === 'lab' && (
        <div style={{ backgroundColor: '#ffffff', border: '1px solid #cbd5e1', borderRadius: '16px', padding: '24px' }}>
          ...
          {labReports.length > 0 ? (
                ...
                <div key={report.id} style={{ border: '1px solid #e2e8f0', borderRadius: '12px', padding: '20px', backgroundColor: '#f8fafc', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    ...
                    <div style={{ fontSize: '0.85rem', color: '#64748b' }}>
                      Patient: <strong>{report.patientName} ({report.patientId})</strong> • Ordered by: {report.orderedDoctor}
                    </div>
                  </div>
            ...
            <div style={{ textAlign: 'center', padding: '36px', color: '#94a3b8', fontSize: '0.92rem' }}>
              No lab reports published in database yet.
            </div>
          )}
        </div>
      )}
      ...
      {activeTab === 'pharmacy' && (
        <div style={{ backgroundColor: '#ffffff', border: '1px solid #cbd5e1', borderRadius: '16px', padding: '24px' }}>
          ...
          {prescriptions.length > 0 ? (
            ...
            <div style={{ textAlign: 'center', padding: '36px', color: '#94a3b8', fontSize: '0.92rem' }}>
              No prescriptions logged in database yet.
            </div>
          )}
        </div>
      )}
              ...
              {patients.map((p) => (
                <div key={p.id} style={{ border: '1px solid #e2e8f0', borderRadius: '12px', padding: '16px', backgroundColor: '#f8fafc' }}>
                  ...
                  <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '12px' }}>
                    Age: {p.age != null ? p.age : '—'} • Gender: {p.gender || '—'} • Blood Group: {p.bloodGroup || '—'}
